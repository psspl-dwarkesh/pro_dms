...
- Marketing campaigns and audiences, Group analytics, Workforce analysis, Branch performance, and used-vehicle operations are backed by tenant-scoped database records. Broader inventory-transfer capabilities remain limited to the persisted workflows explicitly shown in each workspace.
