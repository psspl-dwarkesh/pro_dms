...
const ROLE_CAPABILITIES = {
  ...
  sales_manager: [CAPABILITIES.CUSTOMERS_READ, CAPABILITIES.CUSTOMERS_MANAGE, CAPABILITIES.VEHICLES_READ, CAPABILITIES.VEHICLES_MANAGE, CAPABILITIES.SALES_MANAGE, CAPABILITIES.MARKETING_MANAGE, CAPABILITIES.ANALYTICS_READ],
  bdc_rep: [CAPABILITIES.CUSTOMERS_READ, CAPABILITIES.CUSTOMERS_MANAGE, CAPABILITIES.SALES_MANAGE, CAPABILITIES.MARKETING_MANAGE],
  finance_manager: [
    CAPABILITIES.CUSTOMERS_READ,
    CAPABILITIES.VEHICLES_READ,
    CAPABILITIES.SALES_MANAGE,
