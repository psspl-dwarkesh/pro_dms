...
const ROLE_CAPABILITIES = {
  ...
  sales_manager: [CAPABILITIES.CUSTOMERS_READ, CAPABILITIES.CUSTOMERS_MANAGE, CAPABILITIES.VEHICLES_READ, CAPABILITIES.SALES_MANAGE, CAPABILITIES.ANALYTICS_READ],
