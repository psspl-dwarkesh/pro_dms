...
import { createUser, listUsers, updateOwnProfile, updateUser } from "../db.js";
...
// PATCH /:id route: db.js#updateOwnProfile cannot change role, branch, or active state, so a
