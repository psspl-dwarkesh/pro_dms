...
function PreviewPulse() {
  return <><div className="preview-kpis"><div><span>Revenue to plan</span><strong>104.8%</strong><em>+$284k</em></div><div><span>Gross margin</span><strong>18.6%</strong><em>+0.8 pts</em></div><div><span>Workshop load</span><strong>86%</strong><em>12 live ROs</em></div></div><div className="preview-grid"><div className="preview-chart-card"><div className="preview-card-label"><span>Group operating flow</span><b>Today</b></div><svg viewBox="0 0 440 150" role="img" aria-label="Illustrative revenue trend"><defs><linearGradient id="previewArea" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stopColor="#31d5c5" stopOpacity=".35" /><stop offset="1" stopColor="#31d5c5" stopOpacity="0" /></linearGradient></defs><path d="M0 120 C35 105,55 112,82 88 S130 63,162 76 S220 102,252 67 S302 39,338 55 S390 62,440 22 L440 150 L0 150Z" fill="url(#previewArea)" /><path d="M0 120 C35 105,55 112,82 88 S130 63,162 76 S220 102,252 67 S302 39,338 55 S390 62,440 22" fill="none" stroke="#31d5c5" strokeWidth="3" /></svg></div><div className="preview-exceptions"><div className="preview-card-label"><span>Needs action</span><b>4 critical</b></div><div><i className="bad" /><p><strong>RO-18492</strong><span>Diagnostic blocked</span></p><em>52m</em></div><div><i className="warn" /><p><strong>7 deliveries</strong><span>Promise risk</span></p><em>Today</em></div><div><i className="good" /><p><strong>Finance</strong><span>Best in group</span></p><em>48.2%</em></div></div></div></>;
}
